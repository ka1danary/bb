...
import MyChecbox from '../../ui/checkbox/MyChecbox';

const CreateOrder3 = () => {
    const title = ['Сантехник', 'Репетитор по английскому', 'Учитель по вождению']
    return (
        <div className={moduleCreateOrderPage.create}>
            <div className={moduleCreateOrderPage.createBox}>
                ...
                <div>
                    ...
                    {title.map((el) =>
                        <div style={{ 'margin': '20px' }} className={moduleCreateOrderPage.line}>
                            <div style={{'margin-left' : '10px', 'margin-right' : '20px', 'font-size' : '18px'}}>
                                {el}
                            </div>
                            <MyChecbox />
                        </div>
